...
<html>
    ...
    <body>
        ...
        <div id="show-deposito" class="content scaffold-show" role="main">
            ...
            <f:display bean="deposito" />
            <g:form resource="${this.deposito}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.deposito}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
